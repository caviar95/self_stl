...
PROTOBUF_NAMESPACE_OPEN
template<> ::tutorial::Empty* Arena::CreateMaybeMessage<::tutorial::Empty>(Arena*);
...
class Empty final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:tutorial.Empty) */ {
 public:
...
inline void Person::set_emails(int index, const char* value) {
  ...
  _impl_.emails_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:tutorial.Person.emails)
}
inline void Person::set_emails(int index, const char* value, size_t size) {
  _impl_.emails_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:tutorial.Person.emails)
}
...
inline void Person::add_emails(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.emails_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:tutorial.Person.emails)
}
inline void Person::add_emails(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:tutorial.Person.emails)
}
